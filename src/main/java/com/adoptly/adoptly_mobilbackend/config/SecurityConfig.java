package com.adoptly.adoptly_mobilbackend.config;
...
public class SecurityConfig {
    ...
    // ⚠️ DİKKAT: Render'da bu değerin (Environment Variables) tanımlı olması şart!
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // İleride burayı "*" yerine sadece uygulamanın adresleriyle sınırlayabilirsin
